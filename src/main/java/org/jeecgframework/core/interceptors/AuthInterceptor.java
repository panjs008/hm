...
public class AuthInterceptor implements HandlerInterceptor {
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object object) throws Exception {
		...
		if(requestPath.contains("emailController.do") ||requestPath.contains("hmWorkPriceController.do") ||requestPath.contains("ymkCustomFromController.do") ||requestPath.contains("ymkCustomController.do") || requestPath.contains("duplicateCheckAction.do?doDuplicateCheck")){
			return true;
		}
