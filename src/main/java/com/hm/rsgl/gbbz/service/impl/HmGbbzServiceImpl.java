package com.hm.rsgl.gbbz.service.impl;
...
@Service("hmGbbzService")
@Transactional
public class HmGbbzServiceImpl extends CommonServiceImpl implements HmGbbzServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(HmGbbzEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doUpdateBus(HmGbbzEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doDelBus(HmGbbzEntity t) throws Exception{
	    //-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
 	...
 	private Map<String,Object> populationMap(HmGbbzEntity t){
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,HmGbbzEntity t){
 		...
 		if(StringUtil.isNotEmpty(cgJavaValue)){
			...
			try {
				...
				if(obj instanceof CgformEnhanceJavaInter){
					...
					javaInter.execute("hm_gbbz",data);
				}
			} catch (Exception e) {
				e.printStackTrace();
