package com.hm.kq.checkpay.service.impl;
...
@Service("hmCheckPayService")
@Transactional
public class HmCheckPayServiceImpl extends CommonServiceImpl implements HmCheckPayServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(HmCheckPayEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doUpdateBus(HmCheckPayEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doDelBus(HmCheckPayEntity t) throws Exception{
	    //-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
 	...
 	private Map<String,Object> populationMap(HmCheckPayEntity t){
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,HmCheckPayEntity t){
 		...
 		if(StringUtil.isNotEmpty(cgJavaValue)){
			...
			try {
				...
				if(obj instanceof CgformEnhanceJavaInter){
					...
					javaInter.execute("hm_check_pay",data);
				}
			} catch (Exception e) {
				e.printStackTrace();
