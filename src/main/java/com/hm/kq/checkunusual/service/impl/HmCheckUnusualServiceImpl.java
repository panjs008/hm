package com.hm.kq.checkunusual.service.impl;
...
@Service("hmCheckUnusualService")
@Transactional
public class HmCheckUnusualServiceImpl extends CommonServiceImpl implements HmCheckUnusualServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(HmCheckUnusualEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doUpdateBus(HmCheckUnusualEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doDelBus(HmCheckUnusualEntity t) throws Exception{
	    //-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
 	...
 	private Map<String,Object> populationMap(HmCheckUnusualEntity t){
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,HmCheckUnusualEntity t){
 		...
 		if(StringUtil.isNotEmpty(cgJavaValue)){
			...
			try {
				...
				if(obj instanceof CgformEnhanceJavaInter){
					...
					javaInter.execute("hm_check_unusual",data);
				}
			} catch (Exception e) {
				e.printStackTrace();
