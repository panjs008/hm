...
function createdetailwindow(title, addurl,width,height) {
	...
	if(addurl.indexOf('hmWorkPriceController.do?detail')>=0){
		width =  window.top.document.body.offsetWidth;
		height =window.top.document.body.offsetHeight-100;
	}
	...
	if(addurl.indexOf('emkTestProgressController.do?goAdd')>=0 || addurl.indexOf('emkTestProgressController.do?goUpdate')>=0){
		height =window.top.document.body.offsetHeight-100;
	}
	...
	if(addurl.indexOf('com/emk/produce/produce/emkProduce-process')>=0){
		height =window.top.document.body.offsetHeight-100;
	}
	if(addurl.indexOf('com/emk/storage/price/emkPrice-process')>=0 ){
		...
		width =  window.top.document.body.offsetWidth;
		height =window.top.document.body.offsetHeight-100;
		addurl = addurl + "&wVal="+window.top.document.body.offsetWidth*0.97+ "px&hVal="+(window.top.document.body.offsetHeight-140)+"px&hVal2="+(window.top.document.body.offsetHeight-180)+"px";
	}
	...
	if(addurl.indexOf('com/emk/storage/samplerequired/emkSampleRequired-process')>=0){
		...
		height =window.top.document.body.offsetHeight-100;
		addurl = addurl + "&wVal="+width+ "px&hVal="+(window.top.document.body.offsetHeight-140)+"px&hVal2="+(window.top.document.body.offsetHeight-180)+"px";
