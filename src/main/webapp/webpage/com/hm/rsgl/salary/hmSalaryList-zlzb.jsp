...
<div class="easyui-layout" fit="true">
    <div region="center" style="padding:0px;border:0px">
        <t:datagrid name="hmSalaryList" checkbox="false"  sortName="deptName,workName,groupName" pageSize="20" pagination="true" fitColumns="false" title="" actionUrl="hmSalaryController.do?datagrid&leaveT=1" idField="id" fit="true" btnCls="bootstrap"  queryMode="group">
