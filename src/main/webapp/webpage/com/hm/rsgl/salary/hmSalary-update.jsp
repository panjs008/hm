...
<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="hmSalaryController.do?doUpdate" tiptype="1">
	...
	<table style="width: 100%;" cellpadding="0" cellspacing="1" class="formtable">
		...
		<tr>
			...
			<td class="value">
				<input id="jf" name="jf"  datatype="d" value="${hmSalaryPage.jf }"  type="text" style="width: 150px" class="inputxt"  ignore="ignore" />
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value" colspan="3">
				<textarea  id="remark" style="width:95%;height:30px" class="inputxt" rows="3" name="remark">${hmSalaryPage.remark}</textarea>
