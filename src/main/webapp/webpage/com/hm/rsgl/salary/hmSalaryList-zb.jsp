...
<script type="text/javascript">
    ...
    function printPreview(){
        ...
        openwindow("打印预览",'hmSalaryController.do?jump&r=qtPrintSheetFrm&url=hmSalaryController.do?printPreview&leaveT=0&month='+month+'&deptName='+deptName+'&workName='+workName+"&groupName="+groupName+"&realName="+realName+"&taker="+taker,"hmSalaryList",width,height);
    }
