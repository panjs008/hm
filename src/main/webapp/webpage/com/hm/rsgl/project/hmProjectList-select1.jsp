...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="projectList"  pagination="true" pageSize="20" fitColumns="true" title="" actionUrl="hmProjectController.do?datagrid" idField="id" fit="true" btnCls="bootstrap"  queryMode="group">
