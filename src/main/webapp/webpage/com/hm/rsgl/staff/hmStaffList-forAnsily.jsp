...
<div id="main_list" class="easyui-layout" fit="true">
    <div region="center" style="padding:0px;border:0px">
        <t:datagrid name="hmStaffList" checkbox="false" pagination="false"  sortName="deptCode,workCode" sortOrder="asc" pageSize="20" fitColumns="false" title="" actionUrl="hmStaffController.do?listAllAnsilyByJdbc&deptCode=${param.deptCode}&workCode=${param.workCode}" idField="id" fit="true" btnCls="bootstrap"  queryMode="group">
