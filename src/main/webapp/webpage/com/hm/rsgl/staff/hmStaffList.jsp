...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="hmStaffList" checkbox="true" pagination="true" sortName="deptCode,workCode" sortOrder="asc" pageSize="20" fitColumns="true" title="" actionUrl="hmStaffController.do?datagrid" idField="id" fit="true" btnCls="bootstrap"  queryMode="group">
