...
<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="hmStaffController.do?doAdd" tiptype="1">
	...
	<table style="width: 100%;" cellpadding="0" cellspacing="1" class="formtable">
		<tr>
			...
			<td class="value">
				<input id="realName" name="realName" type="text" datatype="*" validType="hm_staff,real_name,id" style="width: 150px" class="inputxt"  value='${hmStaffPage.realName}'/>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
				<t:dictSelect id="jb" field="jb" typeGroupCode="jb"  datatype="*" defaultVal="default" hasLabel="false" title="级别"></t:dictSelect>
				<span class="Validform_checktip"></span>
