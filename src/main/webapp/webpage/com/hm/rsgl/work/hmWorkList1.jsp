...
<t:datagrid name="hmWorkList" checkbox="false" pagination="true" pageSize="20" sortOrder="desc" sortName="workDate" fitColumns="false" onClick="editRow" title="" actionUrl="hmWorkController.do?datagrid&type=1" idField="id" fit="true" btnCls="bootstrap"  queryMode="group">
   <t:dgCol title="主键"  field="id"  hidden="true"  queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="创建人名称"  field="createName"  hidden="true"  queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="创建人登录名称"  field="createBy"  hidden="true"  queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="创建日期"  field="createDate"  formatter="yyyy-MM-dd"  hidden="true"  queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="所属部门"  field="sysOrgCode"  hidden="true"  queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="日期" frozenColumn="true" field="workDate"  queryMode="single"  width="90"></t:dgCol>
   <t:dgCol title="主班组" field="workGroupName"  query="true"  queryMode="single"  width="90"></t:dgCol>
   <t:dgCol title="主班组代码"  field="workGroupCode"  hidden="true"  queryMode="single"  width="120"></t:dgCol>
      <t:dgCol title="主车间" field="mainWorkName"  query="true"  queryMode="single"  width="90"></t:dgCol>
   ...
   <t:dgCol title="临时借调人员代码"  field="lsJdNamesCode"  hidden="true"  queryMode="single"  width="120"></t:dgCol>
      ...
      <t:dgCol title="项目名称"  field="xmmc"  queryMode="single"  width="160"></t:dgCol>
      ...
      <t:dgCol title="标准单价"  field="price"  queryMode="single"  width="70"></t:dgCol>
   ...
   <t:dgCol title="平均提成"   field="choucheng"  queryMode="single"  width="70"></t:dgCol>
      ...
      <t:dgToolBar title="录入" icon="fa fa-plus" url="hmWorkController.do?goAdd&type=1&winTitle=录入计件（形式二）" funname="add" width="1200" height="630"></t:dgToolBar>
       <t:dgToolBar title="编辑" icon="fa fa-edit" url="hmWorkController.do?goUpdate&winTitle=编辑计件（形式二）" funname="update" width="1200" height="630"></t:dgToolBar>
