...
<t:datagrid name="hmWorkList" checkbox="true" pagination="true" pageSize="20" sortOrder="desc" sortName="workDate" fitColumns="false" onClick="editRow" title="" actionUrl="hmWorkController.do?datagrid&type=3" idField="id" fit="true" btnCls="bootstrap"  queryMode="group">
   ...
   <t:dgCol title="平均提成"   field="choucheng"  queryMode="single"  width="70"></t:dgCol>
      ...
      <t:dgToolBar title="录入" icon="fa fa-plus" url="hmWorkController.do?goAdd&type=3&winTitle=录入计件（形式四）" funname="add" width="1200" height="630"></t:dgToolBar>
       <t:dgToolBar title="编辑" icon="fa fa-edit" url="hmWorkController.do?goUpdate&winTitle=编辑计件（形式四）" funname="update" width="1200" height="630"></t:dgToolBar>
