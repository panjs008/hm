...
<t:datagrid name="hmWorkList" checkbox="false" pagination="false" pageSize="15" sortOrder="desc" sortName="workDate" fitColumns="false"  title="" actionUrl="hmWorkController.do?datagrid&orderId=${param.orderId}" idField="id" fit="true" btnCls="bootstrap"  queryMode="group">
    ...
    <t:dgCol title="规格分类"  field="ggfl"  queryMode="single"  width="100"></t:dgCol>
