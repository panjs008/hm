...
<t:datagrid name="hmWorkList" checkbox="true" pagination="true" pageSize="20" sortOrder="desc" sortName="workDate" fitColumns="false" onClick="editRow" title="" actionUrl="hmWorkController.do?datagrid&type=2" idField="id" fit="true" btnCls="bootstrap"  queryMode="group">
   <t:dgCol title="主键"  field="id"  hidden="true"  queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="创建人名称"  field="createName"  hidden="true"  queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="创建人登录名称"  field="createBy"  hidden="true"  queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="创建日期"  field="createDate"  formatter="yyyy-MM-dd"  hidden="true"  queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="所属部门"  field="sysOrgCode"  hidden="true"  queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="日期" query="true" frozenColumn="true" field="workDate"  queryMode="group"  width="90"></t:dgCol>
   ...
   <t:dgCol title="车间代码"  field="workCode"  hidden="true"  queryMode="single"  width="120"></t:dgCol>
    <t:dgCol title="姓名"  hidden="true" field="realName" query="true"  queryMode="single"  width="200"></t:dgCol>
   ...
   <t:dgCol title="临时借调人员代码"  field="lsJdNamesCode"  hidden="true"  queryMode="single"  width="120"></t:dgCol>
      ...
      <t:dgCol title="项目名称"  query="true" field="xmmc"  queryMode="single"  width="160"></t:dgCol>
      ...
      <t:dgCol title="标准单价" query="true" field="price"  queryMode="single"  width="70"></t:dgCol>
   ...
   <t:dgCol title="平均提成"   field="choucheng"  queryMode="single"  width="70"></t:dgCol>
      ...
      <t:dgToolBar title="录入" icon="fa fa-plus" url="hmWorkController.do?goAdd&type=2&winTitle=录入计件（形式三）" funname="add" width="1200" height="630"></t:dgToolBar>
       <t:dgToolBar title="编辑" icon="fa fa-edit" url="hmWorkController.do?goUpdate&winTitle=编辑计件（形式三）" funname="update" width="1200" height="630"></t:dgToolBar>
