  ...
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="hmLeaveStaffController.do?doAnnual" tiptype="1">
	  ...
	  <table style="width: 100%;" cellpadding="0" cellspacing="1" class="formtable">
		  <tr>
			  ...
			  <td class="value">
				  <input id="annualDate" name="annualDate" readonly  type="text" onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})"  style="width: 150px" class="Wdate"  ignore="ignore"  value='${(hmLeaveStaffPage.annualDate ne null && hmLeaveStaffPage.annualDate ne '') ? hmLeaveStaffPage.annualDate:annualDate}'/>
