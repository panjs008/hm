...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="hmLeaveStaffList" checkbox="false" pageSize="20" pagination="true" fitColumns="true" title="" actionUrl="hmLeaveStaffController.do?datagrid" idField="id" fit="true" btnCls="bootstrap"  queryMode="group">
   ...
   <t:dgCol title="所属部门"  field="sysOrgCode"  hidden="true"  queryMode="single"  width="120"></t:dgCol>
      ...
      <t:dgCol title="离职时间"  field="leaveDate"  queryMode="single"  width="130"></t:dgCol>
      ...
      <t:dgCol title="结算日期"  field="annualDate"  queryMode="single"  width="130"></t:dgCol>
      <t:dgCol title="状态"  field="state" replace="未结算_0,已结算_1"  formatterjs="setColor" query="true" queryMode="single"  width="130"></t:dgCol>
