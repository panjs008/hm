...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="emkApprovalList" checkbox="false" pagination="true" fitColumns="true" pageSize="15" title="审批业务表" actionUrl="emkApprovalController.do?listAllByJdbc" idField="id" fit="true" btnCls="bootstrap"  queryMode="group">
   ...
   <t:dgCol title="创建人登录名称"  field="createBy"  hidden="true"  queryMode="single"  width="120"></t:dgCol>
      ...
      <t:dgCol title="提交人"  field="createName"    queryMode="single"  width="80"></t:dgCol>
   ...
   <t:dgCol title="当前节点代码"  field="processNode"  hidden="true" queryMode="single"  width="120"></t:dgCol>
      ...
      <t:dgCol title="节点状态"  field="status" formatterjs="formatColor"  queryMode="single"  width="110"></t:dgCol>
   <t:dgCol title="审核人"  field="bpmSher"  queryMode="single"  width="80"></t:dgCol>
   ...
   <t:dgCol title="审核时间"  field="bpmDate"  queryMode="single"  width="120"></t:dgCol>
      ...
      <t:dgFunOpt funname="goToProcess(formId,commitId,processNode,status,type,state1,state2,state3)" title="流程进度"  urlclass="ace_button"  urlStyle="background-color:#ec4758;" urlfont="fa-tasks"></t:dgFunOpt>
...
function formatProcessName(val,row){
 ...
 function goToProcess(id,createBy,processName,state,type,state1,state2,state3){
     ...
     createdetailwindow("流程进度--当前环节："+initProcessName, "flowController.do?goProcess&node="+node+ "&state="+state+"&processUrl="+processUrl+"&id=" + id, w, height);
