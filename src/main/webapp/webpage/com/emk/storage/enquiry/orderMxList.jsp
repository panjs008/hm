...
<table style="width:100%;display: none;border: 1px;" cellpadding="0" cellspacing="2" border="0">
    ...
    <tr>
        ...
        <td align="center">
            <%-- <select id="orderMxList[#index#].colorNum00" name="orderMxList[#index#].colorNum" style="width: 86%;" nullmsg="请输入色号！" errormsg="请输入色号" datatype="*">
...
<div class="table-c">
    <table id="mxtb" width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr bgcolor="#F8F8F8" style="height: 32px;" >
            ...
            <td align="center"  width="120" rowspan="2">颜色</td>
            ...
            <c:forEach items="${emkProOrderDetailEntities}" var="poVal" varStatus="status">
                ...
                <tr>
                    ...
                    <td align="center">
                       ...
                       <%-- <select id="color${status.index}" name="orderMxList[${status.index}].color" onchange="setColorNumItem(${status.index})" class="form-control select2" style="width:100px;" datatype="*">
                            <option value=''>请选择</option>
                            <c:forEach items="${colorList}" var="category">
