...
<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="emkEnquiryController.do?doUpdate" tiptype="1">
	...
	<table style="width: 100%;" id="etableid" cellpadding="0" cellspacing="1" class="formtable">
		...
		<tr>
			...
			<td class="value" style="width: 32%">
				<select class="form-control select2" id="businesserId" datatype="*"  disabled>
		...
		<tr>
			...
			<td class="value">
				<input id="ysDate" name="ysDate" readonly value="${emkEnquiryPage.ysDate }" datatype="*"  onClick="WdatePicker({dateFmt:'yyyy-MM-dd',minDate:'#F{$dp.$D(\'kdDate\');}',onpicked:setEndTime})"  type="text" style="width: 150px" class="Wdate"  />
				<span class="Validform_checktip"></span>
			...
			<td class="value">
				<input id="levelDays" name="levelDays" value="${emkEnquiryPage.levelDays }" readonly type="text" style="width: 150px" class="inputxt"  ignore="ignore" />
				<span class="Validform_checktip"></span>
