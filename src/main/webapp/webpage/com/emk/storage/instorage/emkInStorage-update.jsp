...
<head>
	...
	<script type="text/javascript">
		...
		$(document).ready(function(){
			$("#detailId").load("emkInStorageController.do?emkInStorageDetailList&inStorageId=${emkInStoragePage.id }");
			$("#type").val(${emkInStoragePage.type });
		});
	</script>
</head>
<body>

<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="emkInStorageController.do?doUpdate"  tiptype="1">
	<input id="inStorageId" name="inStorageId" type="hidden" value="${emkInStoragePage.id }"/>
	<table style="width: 100%;" cellpadding="0" cellspacing="1" class="formtable">
		<tr>
			...
			<td class="value">
				<input id="rkNo" name="rkNo" value="${emkInStoragePage.rkNo }" readonly type="text" style="width: 150px" class="inputxt"  datatype="*" />
			...
			<td class="value">
				<input id="kdDate" datatype="*" name="kdDate" value="${emkInStoragePage.kdDate }" readonly onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})"  type="text" style="width: 150px" class="Wdate"  ignore="ignore" />
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
				<select id="type" name="type" id="type" datatype="*">
			...
			<td class="value">
				<t:dictSelect id="factoryCode" field="factoryCode" typeGroupCode="factory" datatype="*" defaultVal="${emkInStoragePage.factoryCode }" hasLabel="false" title="供应商"></t:dictSelect>
		...
		<tr>
			...
			<td class="value">
				<input id="yunfei" name="yunfei" datatype="*" value="${emkInStoragePage.yunfei }" type="text" style="width: 150px" class="inputxt"  datatype="/^(-?\d+)(\.\d+)?$/"  ignore="ignore" />
				<span class="Validform_checktip"></span>
			...
			<td class="value">
				<input id="receiveDate" name="receiveDate" value="${emkInStoragePage.receiveDate }" datatype="*" type="text" onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})"  readonly style="width: 150px" class="Wdate"  ignore="ignore" />
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value" colspan="3">
				<input id="remark" name="remark" value="${emkInStoragePage.remark }" type="text" style="width: 150px" class="inputxt"  ignore="ignore" />
				<span class="Validform_checktip"></span>
